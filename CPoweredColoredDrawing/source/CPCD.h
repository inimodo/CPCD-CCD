...
#define _CPCD_BACKCOLOR		100
#define _CPCD_PIXELQUALITY	4
...
struct _CPCD_ELEMENTSTYLE {
	_CPCD_ALIASCOLOR		C_DIVIDER[_CPCD_PIXELQUALITY];
	_CPCD_ALIASCOLOR		C_CORNER[_CPCD_PIXELQUALITY][_CPCD_PIXELQUALITY];
};

#define _CPCD_EVENT CPCD_EVENT
typedef struct _CPCD_EVENT _CPCD_EVENT;
struct _CPCD_EVENT {
	_CPCD_DATA_DEF			USI_ELEMENT;
	_CPCD_DATA_DEF			USI_INDEX;
	_CPCD_DATA_UINT			UI_MSG;
};
...
_CPCD_ELEMENT		_CPCD_FILLELEMENT	(_CPCD_DATA_DEF USI_ELEMENT, 
										_CPCD_ALIASVECTOR V_POSITION, 
										void* V_ELEMENT);

void				_CPCD_ELEMENTRENDER	(_CPCD_ALIAS*		CPCD_CANVAS,
										_CPCD_ELEMENTSTYLE ES_STYLE,
										_CPCD_ELEMENT E_ELEMENT, 
										_CPCD_SPRITE S_SPRITE);

int					_CPCD_INREAGION		(_CPCD_ALIASVECTOR V_POS, 
										_CPCD_DATA_DEF USI_WIDTH,
										_CPCD_DATA_DEF USI_HEIGHT, 
										_CPCD_ALIASVECTOR V_ANCHOR);

...
void _CPCD_DRAWLINE(_CPCD_ALIAS* 	CPCD_CANVAS, _CPCD_ALIASVECTOR	V_LEFT, _CPCD_ALIASVECTOR	V_RIGHT, _CPCD_ALIASCOLOR C_COLOR)
{
	...
	//_CPCD_DATA_RAT usi_deltax = V_LEFT.X - V_RIGHT.X;
	//_CPCD_DATA_RAT usi_deltay = V_LEFT.Y - V_RIGHT.Y;
	//for (float f_render = 1; f_render > 0; f_render -= (1.f/(float) usi_deltax))
	//{
	//	_CPCD_ALIASVECTOR v_deltavec = { usi_deltax*f_render + V_RIGHT.X,usi_deltay*f_render + V_RIGHT.Y };
	//	_CPCD_SETPIXEL(CPCD_CANVAS, v_deltavec, C_COLOR);
	//}
...
void _CPCD_INIT() {
	...
	C_CHARLIST[65].C_VALUE = "01101001111110011001";
	C_CHARLIST[66].C_VALUE = "11101001111010011110";
	C_CHARLIST[67].C_VALUE = "01111000100010000111";
	C_CHARLIST[68].C_VALUE = "11101001100110011110";
	C_CHARLIST[69].C_VALUE = "11111000111010001111";
	C_CHARLIST[70].C_VALUE = "11111000111010001000";
	C_CHARLIST[71].C_VALUE = "11111001100010111111";
	C_CHARLIST[72].C_VALUE = "10011001111110011001";
	C_CHARLIST[73].C_VALUE = "11110010001000101111";
	C_CHARLIST[74].C_VALUE = "11110010001010101110";
	C_CHARLIST[75].C_VALUE = "10011010110010101001";
	C_CHARLIST[76].C_VALUE = "10001000100010001111";
	C_CHARLIST[77].C_VALUE = "10011111100110011001";
	C_CHARLIST[78].C_VALUE = "10011101101110011001";
	C_CHARLIST[79].C_VALUE = "01101001100110010110";
	C_CHARLIST[80].C_VALUE = "11101001111010001000";
	C_CHARLIST[81].C_VALUE = "01101001100110110111";
	C_CHARLIST[82].C_VALUE = "11101001111010101001";
	C_CHARLIST[83].C_VALUE = "01111000111100011110";
	C_CHARLIST[84].C_VALUE = "11110010001000100010";
	C_CHARLIST[85].C_VALUE = "10011001100110010110";
	C_CHARLIST[86].C_VALUE = "10011001100101100110";
	C_CHARLIST[87].C_VALUE = "10011001100111111001";
	C_CHARLIST[88].C_VALUE = "10011001011010011001";
	C_CHARLIST[89].C_VALUE = "10011001011100010001";
	C_CHARLIST[90].C_VALUE = "11110001001001001111";
